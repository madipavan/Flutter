...
import 'package:internshala/Apis/citylist.dart';
...
class AddCity extends StatefulWidget {
  final filterlist;
  AddCity({super.key, this.filterlist});
...
List<Map<String, dynamic>> _Searchlist = Citylist.citylist;
